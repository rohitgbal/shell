...
spark = SparkSession.builder.appName("loadH2TDetails_Reload").enableHiveSupport().getOrCreate()
hive = HiveWarehouseSession.session(spark).build()
parser = argparse.ArgumentParser(description='4G H2T Historical Load')
