...
spark-submit --conf park.yarn.executor.memoryOverhead=$SPARK_EXECUTOR_MEMORY_OVERHEAD \
    ...
    Load_CRC4TStrategyPartNo_Reload.py $DATABASE $CURRENT_USER $CRC4T_STRGYPARTNO_QUERY_DAYS $CURRENT_DATE
