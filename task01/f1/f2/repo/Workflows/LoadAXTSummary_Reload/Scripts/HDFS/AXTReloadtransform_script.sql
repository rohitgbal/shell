...
WHERE tblx01_partition_month_x >= substring('start_date',1,7) and to_date(tblx01_der_event_s_3) >= date_sub('current_date',change_lookback) and AXT.AXTid IS NOT NULL and AXT.AXTstatus IS NOT NULL 
