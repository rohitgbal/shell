...
insert overwrite table ${hivevar:temp_stg_table}
select a.vin,
a.cvrt_version,
a.iccid,
a.esn,
...
from
    ...
    where tblx01_partition_date_x >= date_sub('${hivevar:current_date}', ${hivevar:lkb_days})
    and tblx01_partition_date_x < '${hivevar:current_date}'
    ...
    and tblx01_msg_metadata_msg_typ_x is not null
