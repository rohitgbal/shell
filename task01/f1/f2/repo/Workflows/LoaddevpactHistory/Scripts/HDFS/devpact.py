...
if __name__ == "__main__":
     ...
     spark = SparkSession.builder.appName("MKD Schedule History").enableHiveSupport().getOrCreate()
...
MKDFinalData.write.option('compression', 'zlib').mode("append").orc(output)
