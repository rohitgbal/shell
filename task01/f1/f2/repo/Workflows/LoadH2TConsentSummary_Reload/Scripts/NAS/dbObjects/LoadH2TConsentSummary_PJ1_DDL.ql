...
create table if not exists nscvpbb_H2T_summ_pj1_pii_hte_tmp_hist
(
...
stored as orc
location '/project/prg1/prg1${hivevar:hdfs_env}/Warehouse/Secure/dataprogRepository/nscvpbb_H2T_summ_pj1_pii_hte_tmp_hist'
...
create external table if not exists nscvsbb_H2T_summ_pj1_st_hte_history
(
   vin varchar(17),
   cvrt_version string,
   icc_id string,
...
stored as orc
location '/project/prg1/prg1${hivevar:hdfs_env}/Warehouse/Staging/dataprogRepository/nscvsbb_H2T_summ_pj1_st_hte_history';

create external table if not exists nscvsbb_H2T_summ_pj1_st_hte_tmp_hist
(
   vin varchar(17),
   cvrt_version string,
   iccid string,
...
stored as orc
location '/project/prg1/prg1${hivevar:hdfs_env}/Warehouse/Staging/dataprogRepository/nscvsbb_H2T_summ_pj1_st_hte_tmp_hist';