...
create external table if not exists NSCVSBB_H2T_SUMM_PJ1_TEMP_ST_HTE
(
   vin varchar(17),
   cvrt_version string,
   iccid string,
...
stored as orc
location '/project/prg1/prg1${hivevar:hdfs_env}/Warehouse/Staging/dataprogRepository/nscvsbb_H2T_summ_pj1_temp_st_hte';